...
mkdir dRep_dereplication/dRep_primaryMASH

dRep dereplicate -p 16 -g dRep_dereplication/genomes_list --genomeInfo dRep_dereplication/checkm2.quality_report_dRep_input.csv --S_algorithm fastANI --MASH_sketch 100000 --S_ani 0.995 -strW 0 --debug --SkipSecondary dRep_dereplication/dRep_primaryMASH
